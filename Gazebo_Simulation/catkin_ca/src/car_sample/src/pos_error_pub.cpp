...
static double Dcar_hunter = 0.340;
static double Dtrailer_hunter = 0.660;
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher CarVelopub = nh.advertise<geometry_msgs::Twist>("/joystick/cmd_vel", 100);
